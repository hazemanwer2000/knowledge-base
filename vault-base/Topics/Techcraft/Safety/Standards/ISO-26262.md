...
If a (second) safety mechanism is implemented to detect faults in the (first) safety mechanism, its required ASIL is ASIL-B.
```
#### ASIL Decomposition
---
...
Decomposing an ASIL component into an ASIL and a QM component mandates **freedom of interference** from the QM component onto the ASIL component. Freedom of interference ensures the lack of cascading failures.
